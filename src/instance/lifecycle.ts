...
export async function createInstance(
  ...
  if (!engineEnvFromTemplate) {
    const engineEnvContent = [
      ...
      "#",
      "# Provider: ollama (local, default) | openai (API) | anthropic (Claude API) | sampling (MCP client) | none",
      ...
      "#",
      "# Base model defaults — used unless Dreamer / Normalizer overrides are set",
      ...
      "# DREAMGRAPH_LLM_DREAMER_MODEL=qwen3:8b",
    ...
    logger.debug("engine.env written from in-code fallback scaffold");
  }
